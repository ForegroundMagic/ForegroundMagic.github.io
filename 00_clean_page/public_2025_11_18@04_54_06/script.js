...
function initPanels() {
  ...
  const bottomPanel = document.querySelector(".panel.panel-bottom");
  ...
  const canvasRegistry = {
    "canvas-main-preview-panel": {
      html: "panels/design/canvas/main-preview/panel.html",
      css: "panels/design/canvas/main-preview/panel.css",
      js: "panels/design/canvas/main-preview/panel.js"
    }
  };
  ...
  const canvasManager = createPanelManager({
    hostElement: bottomPanel,
    overlayClassName: "panel-overlay panel-overlay--canvas",
    registry: canvasRegistry,
    allowClose: false
  });

  if (canvasManager) {
    managers.push({ manager: canvasManager, ids: Object.keys(canvasRegistry) });
  }
